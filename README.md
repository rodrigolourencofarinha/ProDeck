...
![ProDeck Toolbar](assets/readme/ProDeck_v1.6.0_Toolbar.png)
...
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|--------------------------------------------------------------------------------------------|
| ![Batch Add or Delete](assets/readme/features/BatchAddDelete.png)                                                     | Batch Add or Delete                                       | Add/Delete objects from all slides.                                                        |
| ![Insert Sticky Note](assets/readme/features/GenerateStickyNote.png)                                                  | Insert Sticky Note                                        | Insert a sticky note on the slide                                                          |
| ![Insert Headings](assets/readme/features/Headings.png)                                                               | Insert Headings                                           | Insert multiple headings                                                                   |
| ![Insert or Reposition Footnote](assets/readme/features/Footnotes.png)                                                | Insert or Reposition Footnote                             | Insert or reposition footnote                                                              |
| ![Multilevel Bullet Points](assets/readme/features/MultilevelBulletPoint.png)                                         | Multilevel Bullet Points                                  | Set multilevel bullet points, ticks or crosses                                             |
| ![Text Box Margins On/Off](assets/readme/features/MarginToggle.png)                                                   | Text Box Margins On/Off                                   | Toggle text box margins on/off                                                             |
| ![Fill Color](assets/readme/features/SelectSimilarFillColor.png)                                                      | Fill Color                                                | Select all objects with the same color                                                     |
| ![All Colors](assets/readme/features/ReplaceAllColors.png)                                                            | All Colors                                                | Replace colors in selected slides                                                          |
| ![Connect Shapes](assets/readme/features/ConnectShapes.png)                                                           | Connect Shapes                                            | Connect side of shape 1 to the side of shape 2                                             |
| ![Increase or Decrease Spacing](assets/readme/features/IncreaseDecreaseSpacing.png)                                   | Increase or Decrease Spacing                              | Increase or decrease spacing between objects                                               |
| ![Swap Positions](assets/readme/features/SwapObjects.png)                                                             | Swap Positions                                            | Swap positions of selected objects                                                         |
| ![Stack Objects](assets/readme/features/StackObjects.png)                                                             | Stack Objects                                             | Stack objects based on the first selected object                                           |
| ![Match Size](assets/readme/features/ResizeObjects.png)                                                               | Match Size                                                | Resize selected objects to match size (height and/or width)                                |
| ![Rectify Lines](assets/readme/features/RectifyLines.png)                                                             | Rectify Lines                                             | Rectify lines to default horizontal or vertical positions                                  |
| ![Merge or Split Text](assets/readme/features/MergeText.png)                                                         | Merge or Split Text                                       | Merge or split text within selected objects into one object                                |
| ![Hide or Unhide Objects](assets/readme/features/HideUnhide.png)                                                      | Hide or Unhide Objects                                    | Hide or unhide objects in the slide                                                        |
| ![Change Language](assets/readme/features/ChangeLanguage.png)                                                         | Change Language                                           | Change proofing language in the entire deck                                                |
| ![Clean Deck](assets/readme/features/CleanDeck.png) | Clean Deck | Offers various functionalities, including the ability to remove all line breaks from a selected shape and eliminate double spaces from selected slides. It allows exporting notes and comments from all slides to a text file, fixing slide footers and numbers, and deleting unwanted properties such as animations, comments, and transitions. Additionally, it provides confidentiality settings to anonymize and erase metadata. |
| ![Label Slides](assets/readme/features/LabelSlides.png)                                                               | Label Slides                                              | Label slides and contents                                                                  |
| ![Classify Document](assets/readme/features/ClassifyDocument.png)                                                     | Classify Document                                         | Put mark on all slides regarding the document classification                               |
